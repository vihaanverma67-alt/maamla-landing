...
const CATALOG: NgoEntry[] = [
	...
	// ── India additions ───────────────────────────────────────────────────────
	{
		title: 'Teach For India Fellow / Volunteer',
		org: 'Teach For India',
		url: 'https://www.teachforindia.org/join-us',
		description: 'Time: 8-10 hrs/week · Duration: 2-year fellowship or 1-semester volunteer · Cert: TFI completion certificate · Teach low-income students in government schools across 8 Indian cities. One of India\'s most prestigious social sector fellowships.',
		location: 'Mumbai / Delhi / Pune / Bengaluru, India',
		region: 'india',
		deadline: null,
	},
	{
		title: 'Akshara Foundation Literacy Volunteer',
		org: 'Akshara Foundation',
		url: 'https://www.akshara.org.in/volunteer',
		description: 'Time: 3-5 hrs/week · Duration: 3-6 months · Cert: Volunteer certificate · Improve early-grade reading and numeracy in government schools in Karnataka. Tech and data volunteers especially welcome.',
		location: 'Bengaluru / Karnataka, India',
		region: 'india',
		deadline: null,
	},
	{
		title: 'Pratham Digital Volunteer',
		org: 'Pratham',
		url: 'https://www.pratham.org/get-involved/volunteer/',
		description: 'Time: 3-6 hrs/week · Duration: 3 months+ · Cert: Volunteer certificate · Support India\'s largest education NGO with digital literacy, data entry, content creation, and teaching across 21 states.',
		location: 'Pan-India / Online',
		region: 'india',
		deadline: null,
	},
	{
		title: 'Magic Bus Youth Worker Volunteer',
		org: 'Magic Bus India Foundation',
		url: 'https://www.magicbus.org/volunteer',
		description: 'Time: 4-6 hrs/week · Duration: 3-6 months · Cert: Volunteer certificate · Mentor children from disadvantaged communities in life skills, health, and employability through sport-based learning.',
		location: 'Mumbai / Delhi / Chennai, India',
		region: 'india',
		deadline: null,
	},
	{
		title: 'NASSCOM Foundation Tech Volunteer',
		org: 'NASSCOM Foundation',
		url: 'https://www.nasscomfoundation.org/collaborate/volunteer',
		description: 'Time: 3-5 hrs/week · Duration: 3-12 months · Cert: Volunteer certificate · Use tech skills (web, data, UX) to support NGO partners across digital literacy, employability, and accessibility initiatives.',
		location: 'Online / Pan-India',
		region: 'india',
		deadline: null,
	},
	{
		title: 'iVolunteer Social Project Volunteer',
		org: 'iVolunteer India',
		url: 'https://www.ivolunteer.in/search',
		description: 'Time: 2-8 hrs/week · Duration: Flexible · Cert: Participation certificate · Browse 500+ verified NGO volunteer roles across education, environment, health, and animal welfare through India\'s largest volunteering platform.',
		location: 'Online / Pan-India',
		region: 'india',
		deadline: null,
	},
	{
		title: 'Samhita Social Ventures Volunteer',
		org: 'Samhita Social Ventures',
		url: 'https://samhita.org/volunteer/',
		description: 'Time: 4-6 hrs/week · Duration: 3-6 months · Cert: Volunteer certificate · Research, content, and data support roles helping corporations and NGOs collaborate on CSR and development projects.',
		location: 'Mumbai / Online, India',
		region: 'india',
		deadline: null,
	},
	{
		title: 'Smile Foundation Education Volunteer',
		org: 'Smile Foundation',
		url: 'https://www.smilefoundationindia.org/volunteer.html',
		description: 'Time: 4-6 hrs/week · Duration: 3-6 months · Cert: Volunteer certificate · Teach STEM, English, or digital skills to underprivileged children in 25 states. Missions like Shiksha offer structured school outreach.',
		location: 'Pan-India',
		region: 'india',
		deadline: null,
	},
	...
	// ── Global additions ──────────────────────────────────────────────────────
	{
		title: 'UN Volunteers Online',
		org: 'United Nations Volunteers',
		url: 'https://www.onlinevolunteering.org/',
		description: 'Time: 5-10 hrs/week · Duration: 1-12 months · Cert: UN completion certificate · Online volunteer assignments with UN agencies and NGOs worldwide in tech, communication, research, and translation.',
		location: 'Online / Global',
		region: 'global',
		deadline: null,
	},
	{
		title: 'Wikipedia / Wikimedia Contributor',
		org: 'Wikimedia Foundation',
		url: 'https://www.wikimedia.org/wiki/Wikimedia_volunteers',
		description: 'Time: 2-5 hrs/week · Duration: Ongoing · Cert: Recognised contributor badge · Edit and expand Wikipedia articles in any language; contribute to Wikidata, Commons, or software engineering. Fully online.',
		location: 'Online / Global',
		region: 'global',
		deadline: null,
	},
	{
		title: 'Open Source Contributor — Mozilla',
		org: 'Mozilla Foundation',
		url: 'https://community.mozilla.org/',
		description: 'Time: 3-8 hrs/week · Duration: Ongoing · Cert: Open source recognition · Contribute to Firefox, MDN Web Docs, or Firefox OS. Code, design, QA, and localisation roles. Globally recognised open-source experience.',
		location: 'Online / Global',
		region: 'global',
		deadline: null,
	},
	{
		title: 'Catchafire Skills-Based Volunteer',
		org: 'Catchafire',
		url: 'https://www.catchafire.org/',
		description: 'Time: 2-20 hrs (project-based) · Duration: Flexible · Cert: Project completion certificate · Match your professional skills (design, data, coding, writing) with US-based nonprofits needing specific deliverables.',
		location: 'Online / Global',
		region: 'global',
		deadline: null,
	},
	{
		...
		description: 'Time: 4-8 hrs/week · Duration: Ongoing · Cert: Brigade recognition · Use coding and design skills to build civic tech tools for local governments. 80+ chapters across the US, with remote participation options.',
		location: 'Online / USA',
		region: 'global',
		deadline: null,
	},
	{
		...
		org: 'Translators Without Borders',
		url: 'https://translatorswithoutborders.org/volunteer/',
		description: 'Time: 4-6 hrs/week · Duration: Ongoing · Cert: Volunteer certificate · Translate health, nutrition, and humanitarian content into underserved languages. Requires proficiency in 2+ languages.',
		location: 'Online / Global',
		region: 'global',
		deadline: null,
	},
	{
		...
		description: 'Time: 3-6 hrs/week · Duration: Flexible · Cert: Volunteer recognition · Conduct research, content writing, social media, and event support for human rights campaigns globally. Remote roles available.',
		location: 'Online / Global',
		region: 'global',
		deadline: null,
	},
	{
		...
		url: 'https://www.worldwildlife.org/about/working-wwf',
		description: 'Time: 3-5 hrs/week · Duration: Flexible · Cert: Volunteer certificate · Support conservation campaigns, events, and communications. Data analytics and digital marketing roles often available remotely.',
		location: 'Online / Global',
		region: 'global',
		deadline: null,
	},
